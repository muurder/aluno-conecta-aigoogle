    ...
    const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
        ...
        const updateEmail = (data: User) => {
            if (data.fullName && data.university) {
                const details = UNIVERSITY_DETAILS[data.university];
        ...
        <div className="min-h-full flex flex-col bg-gray-50">
            ...
            <form onSubmit={handleSubmit} className="p-4 space-y-4 flex-grow overflow-y-auto">
                ...
                <div>
                    ...
                    <input name="validity" value={formData.validity} onChange={handleInputChange} className="mt-1 w-full p-2 border border-gray-300 rounded-lg" />
                </div>
