...
export const COURSE_ICONS: { [key: string]: React.ReactElement } = {
    ...
    "Gastronomia": <AcademicCapIcon className="w-8 h-8" />,
    "Geografia": <MapIcon className="w-8 h-8" />,
    "História": <BuildingLibraryIcon className="w-8 h-8" />,
    "Jornalismo": <MicrophoneIcon className="w-8 h-8" />,
    "Logística": <ArchiveBoxIcon className="w-8 h-8" />,
    "Marketing": <LightBulbIcon className="w-8 h-8" />,
    "Medicina Veterinária": <HeartIcon className="w-8 h-8" />,
    "Nutrição": <HeartIcon className="w-8 h-8" />,
    "Odontologia": <HeartIcon className="w-8 h-8" />,
    "Paisagismo": <PaintBrushIcon className="w-8 h-8" />,
    "Pedagogia": <UsersIcon className="w-8 h-8" />,
    ...
    "Turismo": <GlobeAltIcon className="w-8 h-8" />,
    // Pós-graduação
    ...
    "Especialização em Nutrição Clínica": <HeartIcon className="w-8 h-8" />,
