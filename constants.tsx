...
export const COURSE_ICONS: { [key: string]: React.ReactNode } = {
    ...
    "Engenharia Mecânica": <WrenchScrewdriverIcon className="w-8 h-8" />,
    "Farmácia": <BeakerIcon className="w-8 h-8" />,
    "Fisioterapia": <HeartIcon className="w-8 h-8" />,
    "Fonoaudiologia": <MicrophoneIcon className="w-8 h-8" />,
    "Gastronomia": <WrenchScrewdriverIcon className="w-8 h-8" />,
    "Geografia": <MapIcon className="w-8 h-8" />,
    "História": <BuildingLibraryIcon className="w-8 h-8" />,
    "Jornalismo": <DocumentTextIcon className="w-8 h-8" />,
    "Logística": <ArchiveBoxIcon className="w-8 h-8" />,
    "Marketing": <ChartBarIcon className="w-8 h-8" />,
    "Medicina Veterinária": <HeartIcon className="w-8 h-8" />,
    "Nutrição": <BeakerIcon className="w-8 h-8" />,
    "Odontologia": <HeartIcon className="w-8 h-8" />,
    "Paisagismo": <HomeModernIcon className="w-8 h-8" />,
    "Pedagogia": <AcademicCapIcon className="w-8 h-8" />,
    "Psicologia": <UsersIcon className="w-8 h-8" />,
    "Publicidade e Propaganda": <ChatBubbleLeftRightIcon className="w-8 h-8" />,
    "Relações Internacionais": <GlobeAltIcon className="w-8 h-8" />,
    "Serviço Social": <UsersIcon className="w-8 h-8" />,
    "Sistemas de Informação": <ComputerDesktopIcon className="w-8 h-8" />,
    "Turismo": <MapIcon className="w-8 h-8" />,
    // Pós-graduação
    "MBA em Gestão de Projetos": <BriefcaseIcon className="w-8 h-8" />,
    "MBA em Data Science & Analytics": <ChartBarIcon className="w-8 h-8" />,
    "MBA em Engenharia de Software": <CodeBracketIcon className="w-8 h-8" />,
    "MBA em UX/UI & Product Design": <PaintBrushIcon className="w-8 h-8" />,
    "MBA em Marketing Digital & Growth": <ChartBarIcon className="w-8 h-8" />,
    "MBA em Finanças, Controladoria e Auditoria": <CurrencyDollarIcon className="w-8 h-8" />,
    "MBA em Logística & Supply Chain": <ArchiveBoxIcon className="w-8 h-8" />,
    "MBA em Gestão de Pessoas & Liderança": <UsersIcon className="w-8 h-8" />,
    "Especialização em Direito Digital e LGPD": <ScaleIcon className="w-8 h-8" />,
    "Especialização em Direito Tributário": <ScaleIcon className="w-8 h-8" />,
    "Especialização em Docência no Ensino Superior": <AcademicCapIcon className="w-8 h-8" />,
    "Especialização em Psicologia Organizacional": <UsersIcon className="w-8 h-8" />,
    "Especialização em Enfermagem em UTI": <HeartIcon className="w-8 h-8" />,
    "Especialização em Fisioterapia Traumato-Ortopédica": <HeartIcon className="w-8 h-8" />,
    "Especialização em Arquitetura da Paisagem": <BuildingOffice2Icon className="w-8 h-8" />,
    "Especialização em Design de Interiores": <HomeModernIcon className="w-8 h-8" />,
    "Especialização em Nutrição Clínica": <BeakerIcon className="w-8 h-8" />,
    "Especialização em Implantodontia (Odontologia)": <HeartIcon className="w-8 h-8" />,
};
