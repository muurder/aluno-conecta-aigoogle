...
const StudentIdCard = forwardRef<HTMLDivElement, StudentIdCardProps>(({ user }, ref) => {
  ...
  return (
    <div 
      ref={ref} 
      className="w-full max-w-sm mx-auto rounded-2xl p-6 shadow-lg bg-gradient-to-br from-teal-50 to-cyan-100 text-gray-800 relative overflow-hidden font-sans"
    >
